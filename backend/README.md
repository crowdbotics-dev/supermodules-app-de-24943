...
## Project Structure
    ...
    ├── supermodules_app_de_24943  # Django project configurations
...
1. Clone this repo and `cd supermodules_app_de_24943`
...
2. Clone this repo and `cd supermodules_app_de_24943`
